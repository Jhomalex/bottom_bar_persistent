...
const List<Destination> allDestinations = <Destination>[
  ...
  Destination(1, 'Corporativo', Icons.business, Colors.cyan),
  Destination(2, 'Escuelas', Icons.school, Colors.orange),
  Destination(3, 'Vuelos', Icons.flight, Colors.blue)
];
...
class _TextPageState extends State<TextPage> {
  ...
  void initState() {
    ...
    _textController = TextEditingController(
      text: 'Texto de ejemplo: ${widget.destination.title}',
    );
  }
